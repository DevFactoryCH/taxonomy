...
namespace Devfactory\Taxonomy\Controllers;
...
class TermsController extends BaseController
{
    ...
    public function __construct(Vocabulary $vocabulary)
    {
        ...
        return View::share('layout', $layout);
    }
    ...
    */
    ...
    public function postStore()
    {
        ...
        return redirect()
            ->to(action('\Devfactory\Taxonomy\Controllers\TermsController@getIndex', ['id' => $vocabulary->id]))
    ...
    public function putUpdate($id)
    {
        ...
        return redirect()
            ->to(action([TermsController::class, 'getIndex'], ['id' => $term->vocabulary_id]))
